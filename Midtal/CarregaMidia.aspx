...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-10" style="height:54px">
                                <div>
                                  <ajaxToolkit:AsyncFileUpload ID="AsyncFileUpload1" OnClientUploadComplete="uploadCompleted" OnClientUploadError="uploadError" OnUploadedComplete="fileUploadCompleted" runat="server" />                   
                          ...
                          <div class="form-group">
                            <div class ="col-md-7 col-md-pull-0 ">
                                ...
                                <asp:GridView ID="GridViewMidias" runat="server" DataKeyNames="midia" Width="100%" OnSelectedIndexChanged="GridViewMidias_SelectedIndexChanged"  OnRowDataBound="GridViewMidias_RowDataBound"  ShowHeaderWhenEmpty="false" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None"  >
                                    <Columns>
                      ...
                      <asp:Button ID="visualizar" runat="server" Text="Visualizar" OnClick="visualizar_Click" CssClass="btn btn-primary"  />
                        <%--  <a href="#PopupMidias" role="button" class="btn btn-primary" data-toggle="modal">Visualizar</a> --%>
        ...
        <div class="modal fade" id="PopupMidias" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <video id="videoStreamer" runat="server" class="video-stream html5-main-video" poster="Videos/2014-08-10 13.34.18.jpg"  width="540" height="450" controls="controls">
        ...
        <asp:TextBox id="hdnMidia" runat="server" OnDataBinding="Page_Load" AutoPostBack="true" ClientIDMode="Static"/>
    </div>
    <script type="text/javascript">
